...
<head>
    ...
    <title>Welcome | Hospital Core</title>
...
<body>
    ...
    <main class="main">
        <div class="welcome-message">
            ...
            <p>Manage your appointments and view patient details from here.</p>
        </div>
        <div class="cta-buttons">
            <a href="<%= request.getContextPath() %>/register/register-update.jsp">Update Profile</a>
            <a href="<%= request.getContextPath() %>/appointments/doctorAppointments.jsp">View Appointments</a>
        </div>
    </main>
