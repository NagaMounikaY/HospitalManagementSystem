  ...
  <!-- Header -->
    <header>
        <div class="container">
            ...
            <nav>
                <ul>
                    <li><a href="<%= request.getContextPath() %>/Doctor/Doctor-list.jsp"><i class="fa fa-fw fa-home"></i><strong>Home</strong></a></li>
                    <li><a href="<%= request.getContextPath() %>/register/register-update.jsp"><i class="fa fa-fw fa-user"></i><strong>Profile</strong></a></li>
                    <li>
    <a href="<%= request.getContextPath() %>/paidAppointments?action=doctorAppointments">
