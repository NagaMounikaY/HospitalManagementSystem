    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (PDDocument document = new PDDocument()) {
                ...
                // Helper method to write multi-line text
                ...
                yPosition = writeLines.apply("Medicine Details: " + prescription.getMedicineDetails(), yPosition);
                yPosition -= lineHeight; // extra space
                yPosition = writeLines.apply("Notes: " + (prescription.getNotes() != null ? prescription.getNotes() : ""), yPosition);
